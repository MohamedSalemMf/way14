...
// var elementsAr = document.getElementById("arBtn");

// elementsAr.addEventListener("click", function () {
// 	// window.alert("Hello");
// 	document.querySelector(".enBtn").style.display = "none";
// 	document.querySelector(".arBtn").classList.remove("d-none");
// 	// document.querySelector(".rtl-ltr").style.textCenter = "right";

// })


// var elementsEn = document.getElementById("enBtn");
// elementsEn.addEventListener("click", function () {
// 	// window.alert("Hello");
// 	document.querySelector(".enBtn").style.display = "inline-block";
// 	document.querySelector(".arBtn").classList.add ("d-none");
...
// 	let maxs = $("#demo").addClass("rtl-ltr");
...
// 	if(wScroll > 100 ){
// 		// $(".nav-way").css("backgroundColor", "rgba(56, 56, 56,1)");
// 		$(".nav-way-p").css("padding", "0px 40px");
// 	}
// 	else{	
// 		// $(".nav-way").css("backgroundColor", "#383838");
// 		$(".nav-way-p").css("padding", "0px 0px");
// 	}
// })
